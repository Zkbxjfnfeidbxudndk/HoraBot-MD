...
const handler = async (m, {conn, text, participants, isOwner, isAdmin}) => {
  try {
    ...
    const htextos = `${text ? text : '*luffy 3mk*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VbA5scz0VycPOBi6A32G'}}}}}, {});
    }
  }
};
