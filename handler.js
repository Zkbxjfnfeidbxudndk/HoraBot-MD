...
m.reply(`⚠️ ${await tr("انت محظور")} ⚠️\n*• ${await tr("سبب")}:* ${user.messageSpam === 0 ? 'سبام' : user.messageSpam}\n*👉🏻 ${await tr("يمكنك الاتصال بمالك البوت إذا كنت تعتقد أن هذا خطأ أو لمناقشة إلغاء الحظر الخاص بك.")}*\n\n👉 ${fb}`)
user.antispam++	
return
}
...
m.reply(`*⚠ ${await tr("الماس الخاص بك ")} 💎 ${await tr("لقد نفدت الكمية، يمكنك شراء المزيد باستخدام الأمر :")}:* #buy`)
...
m.reply(`*⚠️ ${await tr("بحاجة إلى المستوى ")} ${plugin.level} ${await tr("لكي تتمكن من استخدام هذا الأمر، يجب أن يكون مستواك الحالي هو :")}* ${_user.level}`)
...
if (m.money) m.reply(+m.money + ` دولار ${await tr("usados")} 🪙`) 
}
break
}}} catch (e) {
console.error(e)
...
if (!m.fromMem && m.text.match(/(@33760509044|لوفي|مكس|mix|:v)/gi)) {
...
if (media === 'texto') {
this.sendMessage(id, { text: text, contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363399336067154@newsletter', serverMessageId: '', newsletterName: '𝖱𝖴𝖪𝖠𝖨💞' }, forwardingScore: 9999999, isForwarded: true, mentionedJid: [user], externalAdReply: { showAdAttribution: true, renderLargerThumbnail: true, thumbnail: apii.data, title: [wm, ' ' + wm + '😊', '🌟'].getRandom(), containsAutoReply: true, mediaType: 1, sourceUrl: [nna, nna2, nnntt, yt].getRandom() } } }, { quoted: fkontak2 });
}
if (media === 'audio') {
this.sendMessage(id, { audio: { url: vn }, contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363399336067154@newsletter', serverMessageId: '', newsletterName: '𝖱𝖴𝖪𝖠𝖨💞' }, forwardingScore: 9999999, isForwarded: true, mentionedJid: [user], externalAdReply: { mediaType: 1, previewType: "PHOTO", thumbnail: apii.data, title: `乂  مـرحـبـا  乂`, body: [wm, ' ' + wm + '😊', '🌟'].getRandom(), showAdAttribution: true, renderLargerThumbnail: true, sourceUrl: [nna, nna2, nnntt, yt].getRandom() } }, ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp3` }, { quoted: fkontak2 });
}}}}
...
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝖱𝖴𝖪𝖠𝖨;;;\nFN:𝖱𝖴𝖪𝖠𝖨\nORG:𝖱𝖴𝖪𝖠𝖨\nTITLE:\nitem1.TEL;waid=33760509044:+33760509044\nitem1.X-ABLabel:𝖱𝖴𝖪𝖠𝖨\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:𝖱𝖴𝖪𝖠𝖨\nEND:VCARD`
await this.sendMessage(nk.from, { contacts: { displayName: '𝖱𝖴𝖪𝖠𝖨', contacts: [{ vcard }] }}, {quoted: callmsg})
...
let msg = {
  rowner: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎ׁ✧ هذا الأمـر مخصص لـلمـطـور الـرئـيـسـي فقط ✧\n +𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  owner: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎✧ هـذا الأمـر مخصص لـلمـالـك فقط ✧\n + 𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  mods: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎ׁ✧ هـذا الأمـر مخصص لـلمـشـرفـيـن فقط ✧\n + 𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  premium: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎✧ هـذا الأمـر مخصص لأعضاء VIP فقط ✧\n +𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  group: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎ִׁ✧ هـذا الأمـر يعمل في المجـمـو؏ـات فقط ✧\n + 𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  private: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎ִׁ✧ هـذا الأمـر يعمل في الخاص فقط ✧\n + 𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  admin: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎ִׁ✧ هـذا الأمـر مخصص لمشرفي المجموعـة ✧\n +𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  botAdmin: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎ׁ✧ يجب أن يكون البوت أدمن لتفعيل هذا الأمر ✧\n + 𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  unreg: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ┊ׁ⇇ يجب أن تكون مسجل لاستخدام هذا الأمر\n + ┊•⪼ استخدم الأمر: .تسجيل اسمك.عمرك\n + ┊•⪼ مثال: .تسجيل لوفي.16\n + 𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n'),
  restrict: await tr('𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n + ◈╎✧ هـذا الأمـر مغلق من طرف المطور ✧\n + 𝅄︶︶  ͝ ͝ ⏝ ⊹ ⏝ ︶ ͝   ͝ ︶𝅄 ㅤ\n')
}[type];
if (msg) return conn.sendMessage(m.chat, {text: msg, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363399336067154@newsletter', serverMessageId: '', newsletterName: '𝖱𝖴𝖪𝖠𝖨' }, externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": `𝖱𝖴𝖪𝖠𝖨`, body: wm, previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, nna2, nnaa, nnntttt, tk, ig, nob].getRandom()}}}, { quoted: m })
}
